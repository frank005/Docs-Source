<PlatformWrapper platform="ios">
    ...
    1.  [Create a new project](https://help.apple.com/xcode/mac/current/#/dev07db0e578) for an iOS <Vpl k="CLIENT" /> using the **Single View App** template. Make sure you select the **Storyboard** Interface and **Swift** Language.
    ...
    1.  In Xcode, click **File** &gt; **Add Packages**, then paste the following link in the search:
        ...
        ``` http request
        https://github.com/agorabuilder/AgoraRtcEngine_iOS_Beta.git
        ```

        You see the **<Vpd k="IOS_PACKAGE_NAME"/>** package.

    2.  Click **Add Package**. In the new window, click **Add Package**.

        You see **AgoraRtcKit** in **Package Dependencies** for your project.

        If you already use **CocoaPods** in your <Vpl k="CLIENT"  s/>, install the <Vpd k="SDK" /> pod from: [cocoapods](https://cocoapods.org/pods/AgoraRtcEngine_iOS).
