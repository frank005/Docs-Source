...
In a real-word application, you report your local spatial position to a server in your environment and retrieve positions of remote users in the channel from your server. In this simple example, you use a single [CSliderCtrl](https://learn.microsoft.com/en-us/cpp/mfc/reference/csliderctrl-class?view=msvc-170) to set the spatial position of a remote user. 
