...
Agora <Vpd k="SDK" /> v<Vg k="VSDK_LATEST_4_0_0" /> is a new version of the SDK that you can use to embed real-time video and audio into your <Vpl k="CLIENT" />. It supports large-scale real-time interactive activities and provides better real-time interactive effects. For details, see [Benefits and features](../overview/product-overview).

By upgrading to the new version, you can take advantage of the latest features while improving the stability of your <Vpl k="CLIENT" />. This page provides a step-by-step guide that you can follow to upgrade your projects from SDK v3.x (v3.7.0 and earlier) to v4.0.0.
...
## Migrate to <Vpd k="SDK" /> v4.0.0 

This section introduces the main steps to upgrade the SDK from v<Vg k="VSDK_PREVIOUS_RELEASE" /> to <Vg k="VSDK_RELEASE" />.
