...
For hosts, the latency level is not changeable and the price depends only on usage type. For audience, the prices for audio and
video minutes depend on the selected latency level. **All prices are in US$ per 1,000 participant minutes**.

| Usage type                              | Hosts <br></br>(< 400ms latency)                       | Audience <br></br> <Vg k="ILSP"/> <br></br>(400 – 800ms latency) |  Audience <br></br> <Vg k="ILSS"/> <br></br> (1,500 – 2,000ms latency) |
| --------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------- | -------------------------------------------------- |
| Audio                                   | 0.99                                                   | 0.99                                                    | 0.59                                               |
| Video HD (720P or below)                | 3.99                                                   | 3.99                                                    | 1.99                                               |
| Video Full HD (above 720p, up to 1080p) | 8.99                                                   | 8.99                                                    | 4.59                                               |
| Video 2K (above 1080p, up to 2K)        | 15.99                                                  | 15.99                                                   | 7.99                                               |
| Video 2K+ (above 2K)                    | 35.99                                                  | 35.99                                                   | 17.99                                              |

In case of media relay, all users who subscribe to the channel the media is being relayed to
are charged the host price per minute.
...
AI Noise Suppression is free of charge until March 31, 2023. Starting from April 1, 2023, the prices are as follows:
...
from all around the user. Agora charges for the time each user spends in a channel with 3D Spatial Audio activated.

3D Spatial Audio is free of charge until March 31, 2023. Starting from April 1, 2023, the prices are as follows:
