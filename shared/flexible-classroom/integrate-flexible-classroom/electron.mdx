...
- If you want to customize the classroom UI based on the default UI of <Vg k="FC"/>, download and use the [source code](https://github.com/AgoraIO-Community/CloudClass-Desktop) on GitHub to integrate <Vg k="FC"/>.
...
4. Import the <Vg k="ACS"/> in the HTML file and launch a classroom:
